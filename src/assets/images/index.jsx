const Logo = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="118" height="42" fill="currentColor" alt="TikTok">
      ...
      ></path>
      <symbol data-count="2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" id="Music_Note-8c658968">
      ...
      <symbol data-count="2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" id="Play_Fill-6957a00f">
      ...
      <symbol
        ...
        viewBox="0 0 48 48"
        id="Ellipsis_Horizontal_Fill-9ee69fcf"
      >
        <path d="M4 24a5 5 0 1 1 10 0 5 5 0 0 1-10 0Zm15 0a5 5 0 1 1 10 0 5 5 0 0 1-10 0Zm20-5a5 5 0 1 0 0 10 5 5 0 0 0 0-10Z"></path>
      </symbol>
      <symbol data-count="2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="heart-fill-03bd63df">
      ...
      <symbol data-count="2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="uncollect-8a52664d">
        <path
          fill="currentColor"
      ...
      <symbol data-count="2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" id="pc-share-44d9fe83">
        <path
          fill="currentColor"
          fillRule="evenodd"
      ...
      <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 19" id="pc-6845b35b">
        <path
          fill="currentColor"
